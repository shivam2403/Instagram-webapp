import { Avatar, Box, Button, Divider, Flex, GridItem, Image, Modal, ModalBody, ModalCloseButton, ModalContent, ModalHeader, ModalOverlay, Text, VStack, useDisclosure } from "@chakra-ui/react";
          ...
          <ModalBody bg={'black'} pb={5} >
            <Flex gap={4} w={{base:'90%', sm:'70%', md:'full'}} mx={'auto'} maxH={'90vh'} minH={'50vh'}>
                <Flex justifyContent={'center'} alignItems={'center'} borderRadius={4} overflow={'hidden'} border={'1px solid'} borderColor={'whiteAlpha.300'} flex={1.5}>
                    <Image alignSelf={'center'} w={'full'} objectFit={'cover'} maxH={'90vh'} minH={'50vh'} src={post?.imageURL} alt="Profile Post"/>
                </Flex>
                <Flex flex={1} flexDir={'column'} px={10} display={{base:'none',md:'flex'}}>
                    ...
                    <VStack w={'full'} gap={3} alignItems={'start'} maxH={'350px'} overflowY={'auto'}>
